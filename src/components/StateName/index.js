    ...
    return (
      <div className="column">
        <div className="state-tested-container">
          <h1 className="heading heading-container">{listStateName}</h1>
          <div>
        ...
        <div>
          <p className="date">{`Last update on ${
        ...
        <div className="top-districts">
          <h1 className={`top-districts-heading stateRoute-${category}`}>
            Top Districts
          </h1>
          <div className="ul">
        ...
        <div className="chart-container" testid="lineChartsContainer">
